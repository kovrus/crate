...
/**
 * A iterator used to navigate over batched data.
 * A iterator usually contains some data already in-memory.
...
public interface BatchIterator {
     ...
     * Until the future completes the behaviour of the other methods is undefined.
     *
